...
export default function BloodPressureLogTable({
  ...
  return (
    <div className="bg-neutral-50 border border-[#eaeaea] border-solid relative rounded-[12px] h-full w-full overflow-hidden flex flex-col">
      <div className="content-stretch flex items-start overflow-y-auto overflow-x-clip relative rounded-[inherit] w-full flex-1" style={{ paddingBottom: '16px' }}>
        {/* S/N Column */}
